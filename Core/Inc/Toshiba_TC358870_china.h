...
/* Debug: dump important TC358870 registers to serial */
void Toshiba_DumpRegisters(void);
/* Try to enable MIPI PLL and lanes, then verify by reading registers */
void Toshiba_EnableMIPI(void);
/* Reset/power-cycle panel, retry enabling MIPI and dump registers */
